...
def webhook():
    ...
    r = requests.post("https://translate.api.cloud.yandex.net/translate/v2/translate", json={r"sourceLanguageCode": r"ru",r"targetLanguageCode": r"en",r"texts": [data["ToTranslate"]],r"folderId": r"b1g15f5au931q1a4dqve"}, headers=headers)
    print(r)
    print(r.content)
